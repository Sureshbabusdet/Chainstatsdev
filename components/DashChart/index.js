                        ...
                        <div className="col-md-12">
                            <div className="seller__item">
                                <div className='row align-items-center'>
                                    ...
                                    <div className='col-lg-4 col-md-4 position-relative zIndex-3'>
                                        <Image width={2} height={300} alt='devider' src="/img/devider-line.png" layout="raw" className='line-devider left-line' />
                                        <Gauge2 />
                                        <div className='box-shadow-gauge'></div>
                                        <Image width={2} height={300} alt='devider' src="/img/devider-line.png" layout="raw" className='line-devider right-line' />
                                    </div>
                                    <div className='col-lg-4 col-md-4 position-relative zIndex-3'>
                                        <Gauge3 />
                                        <div className='box-shadow-gauge'></div>
