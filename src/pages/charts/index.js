...
Charts.getLayout = (page) => <MainLayout>{page}</MainLayout>;
                    ...
                    <Col lg={9}>
                        <div className='tabbed round'>
                            <ul>
                                ...
                                <li className={Symbol === 'BITSTAMP:UNIUSDT' && 'active'} onClick={() => setSymbol('BITSTAMP:UNIUSDT')}>Orderbook</li>
                                <li className={Symbol === 'BITSTAMP:MATICUSDT' && 'active'} onClick={() => setSymbol('BITSTAMP:MATICUSDT')}>Liquidation</li>
                            </ul>
                        </div>
                                        ...
                                        <Table className='table-borderless bg-transparent borderless-table hovered-effect'>
                                            ...
                                            <tbody>
                                                {tableData.map((rowData, index) => (
                                                    <tr key={index}>
                                                        <td className='bg-transparent'><Image width={20} height={20} quality={100} src={rowData.image} alt={rowData.wallet} className='me-2 hoverable-image' /> {rowData.wallet}</td>
