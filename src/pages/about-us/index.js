                    ...
                    <div className="row">
                        <div className="col-xxl-12">
                            <div className="section__title-wrapper text-center mb-55">
                                <h3 className="section__title-3">Interested in <span className="from-red-600 to-violet-600 text-transparent bg-clip-text"> joining us? </span></h3>
                            </div>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                            ...
                            <div className="join__item text-center mb-30">
                                ...
                                <div className="join__content">
                                    ...
                                    <div className="join__btn">
                                        <a href="chainguardians.php" className="tp-btn-4">sign up</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="join__item text-center mb-30">
                                ...
                                <div className="join__content">
                                    ...
                                    <div className="join__btn-gradient">
                                        <a href="#" className="tp-btn-4"><span className="__cf_email__" >info@chainstats.pro</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
